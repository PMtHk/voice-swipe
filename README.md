...
> 음성 명령으로 유튜브 쇼츠와 인스타그램 릴스를 넘기는 크롬 익스텐션

요리 중이거나 손이 자유롭지 않을 때 "다음" 한 마디로 숏폼을 넘겨보세요.
...
1. 익스텐션 설치 후 YouTube Shorts 또는 Instagram Reels 페이지 접속
...
- **다단계 fallback**: 키보드 이벤트 → 스크롤 → 버튼 클릭
...
├── content.js            Web Speech API + DOM 컨트롤
...
### v1 (현재)
- [x] 음성 명령 인식
- [x] YouTube Shorts / Instagram Reels 지원
- [x] 한국어 / 영어
- [x] 민감도 조절
- [ ] 크롬 웹스토어 출시
